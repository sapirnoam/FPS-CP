...
namespace MalbersAnimations.Selector
{
    ...
    public partial class SelectorController
    {
        ...
        float InertiaLastDrag = 0;
        /// <summary>
        /// is the Selector moving by inertia
        /// </summary>
        bool isInInertia;
        /// <summary>
        /// Speed acumulated while draging
        /// </summary>
        protected float DeltaSpeed;
        /// <summary>
        /// Drag on the Last Frame
        /// </summary>
        ...
        /// <summary>
        /// Initial transform of the whole  Selector
        /// </summary>
        protected DeltaTransform InitialTransform; 

        /// <summary>
        /// The Angle between Items       (For Circle Selector)
        /// </summary>
        protected float angle 
        {get {return S_Editor.Angle;} }

        /// <summary>
        /// The Distance between items    (For Linear Selector) 
        /// </summary>
        ...
        /// <summary>
        /// Initial Camera Position where the CircleEditor edited it
        /// </summary>
        protected Vector3 InitialPosCam;
        
        
        /// <summary>
        /// Current Selected Mitem
        /// </summary>
        private MItem current;                                      

        /// <summary>
        /// Gets the total of the Rows for the grid 
        /// </summary>
        protected int Rows                                          
        { get { return Items.Count / S_Editor.Grid + 1; } }

        /// <summary>
        /// Gets the total grid size
        /// </summary>
        protected int GridTotal                                     
        ...
        {
            get { return !isRestoring && !IsSwapping && !isAnimating; }
        }


        /// <summary>
        /// Reference for the Selector Editor
        /// </summary>
        ...
        /// <summary>
        /// Reference for the Selector Manager
        /// </summary>
