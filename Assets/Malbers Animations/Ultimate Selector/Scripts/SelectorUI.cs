    ...
    public class SelectorUI : MonoBehaviour
    {
        ...
        public SelectorManager Manager
        {
            get
            {
                if (manager == null)
                {
                    manager = GetComponentInParent<SelectorManager>();
                }
                return manager;
            }
        }
        ...
        /// <summary>
        /// Update the UI and calls SelectorManager.Purchase()
        /// </summary>
        ...
        /// <summary>
        /// Update the UI and calls SelectorManager.SelectItem();
        /// </summary>
        ...
        /// <summary>
        /// Update the UI and calls SelectorManager.RestoreToDefaultData();
        /// </summary>
