...
namespace MalbersAnimations.Selector
{
    ...
    public class SelectorSave
    {
        ...
        /// <summary>
        ///Current Total of coins on the selector
        /// </summary>
        public int Coins;
        /// <summary>
        /// Default ammount of coins to return to when Restore Data is called
        /// </summary>
        public int RestoreCoins;
        /// <summary>
        /// Saves the last focused item on the Selector
        /// </summary>
        public int FocusedItem;

        /// <summary>
        /// List of all current Locked Items
        /// </summary>
        public List<bool> Locked;

        /// <summary>
        /// List of all Initial Locked Items to restore when Restore Data is called
        /// </summary>
        public List<bool> RestoreLocked;

        /// <summary>
        /// The current elements amount  of each item on the selector
        /// </summary>
        public List<int> ItemsAmount;

        /// <summary>
        /// The Default elements amount of each item on the selector to restore when Restore Data is called
        /// </summary>
        public List<int> RestoreItemsAmount;

        /// <summary>
        /// Are the Selector Items using the Material-Changer component?
        /// </summary>
        public bool UseMaterialChanger;

        /// <summary>
        /// Current Material Item Index the items are using
        /// </summary>
        public List<string> MaterialIndex;

        /// <summary>
        /// Default Material Item Index the items were using to restore when Restore Data is called
        /// </summary>
        public List<string> RestoreMaterialIndex;

        /// <summary>
        /// Are the Selector Items using the  Active-Mesh component?
        /// </summary>
        public bool UseActiveMesh;

        /// <summary>
        /// Current Active Mesh Item Index the items are using
        /// </summary>
        public List<string> ActiveMeshIndex;

        /// <summary>
        /// Default Active Mesh Item Index the items were using to restore when Restore Data is called
        /// </summary>
